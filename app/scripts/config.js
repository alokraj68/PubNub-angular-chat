...
function configState($stateProvider, $urlRouterProvider, $compileProvider) {
    ...
    $stateProvider
        ...
        .state('app_views.public_chat_view', {
            url: "/public_chat_view",
            templateUrl: "views/app_views/public_chat_view.html",
            data: {
                pageTitle: 'Public Chat view',
                pageDesc: 'Create a chat room in your app'
            }
        })
        .state('app_views.private_chat_view', {
            url: "/private_chat_view",
            templateUrl: "views/app_views/private_chat_view.html",
            data: {
                pageTitle: 'Private Chat view',
                pageDesc: 'Create a chat room in your app'
            }
        })
        // Transitions
