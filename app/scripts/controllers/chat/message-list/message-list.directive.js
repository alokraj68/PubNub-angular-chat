angular.module('homer').directive('messageList', function($rootScope, $anchorScroll, MessageService) {
  return {
    restrict: "E",
    replace: true,
    templateUrl: 'scripts/controllers/chat/message-list/message-list.html',
